...
var Module = (function () {
    ...
    _createClass(Module, [{
        key: 'modules',
        value: function modules(mods, mode) {
            var _this = this;
            ...
            this.submodules = new _CompositeModule2['default'](this.configuration.readWithDefaults(_properties.paths.MODULES, []).map(function (path) {
                ...
                loader = new _Loader2['default'](_this.loader.join(_properties.paths.MODULES + '/' + path));
        ...
        value: function connections(types, conns) {
            ...
            return Object.keys(cfgs).map(function (key) {
                ...
                if (!type) throw new Error('Unknown connection type \'' + cfg.type + '\' ' + ('in ' + _this2.loader.join('config.js')));
        ...
        value: function restify(server, plugins) {
            ...
            this.application.interpolate(this.application.framework.restify.plugins, this.configuration.readWithDefaults(API_PLUGINS, plugins)).forEach(function (p) {
            ...
            Object.keys(routes).forEach(function (path) {
                q = new _routingRestifyQ2['default'](path, server);
                Object.keys(routes[path]).forEach(function (method) {
                    return features.install(method, path, routes[path][method], q);
                });
                q.flush();
