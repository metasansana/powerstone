 ...
 */
 class GeneralRouting {
     ...
     * @param {Object} route
     */
     configureSchema(router: Router, route: Object) {
     ...
     * @param {Object} route
     */
     configureMiddleWare(router: Router, route: Object) {
     ...
     * @param {Object} route
     */
     configureQueries(router: Router, route: Object) {
     ...
     * @param {Object} route
     */
     configureControllers(router: Router, route: Object) {
